					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								...
								<div class="card-body">
                  <form  action="{{  route('sectionadd.update', [$sectioni->id]) }}" method="post">
                    @csrf
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-6 col-12">
                      <input type="hidden" class="form-control" name="id" value="{{ $sectioni->id }}">
                      <input type="hidden" name="_method" value="PUT">
												<div class="form-group custom-mt-form-group">
													<input type="text" value="{{ $sectioni->section_name }}" name="section_name" />
