...
<div class="page-wrapper"> <!-- content -->
         ...
         <div class="row">
           <div class="col-lg-7 col-md-12 col-sm-12 col-12">
             <h5 class="text-uppercase">Add Subject</h5>
           </div>
           ...
           <div class="col-lg-12 col-md-12 col-sm-12 col-12">
             <div class="card">
               ...
               <div class="card-body col-lg-06 col-md-12 col-sm-12 col-12">
                 ...
                 @endif
                  <form method="post" action="{{ route('subjectadd.store') }}">
                 <div class="row">
                       @csrf
                   ...
                   <div class="col-lg-06 col-md-12 col-sm-12 col-12">
                     <div class="table-responsive-lg">
                         <table class="table table-striped custom-table datatable">
                             ...
                             <tbody>
                               @foreach ($subjecting as $subjecti)
                                 <tr>
                                     <td>
                                         <h2><a href="">{{ $subjecti->subject_name }}<span></span></a></h2>
                                           </td>
                                          <td class="text-right" >
                                             <a href="{{ route('subjectadd.edit', [$subjecti->id]) }}" class="btn btn-primary btn-sm mb-1">
