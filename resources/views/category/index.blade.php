...
<div class="page-wrapper"> <!-- content -->
         ...
         <div class="row">
           <div class="col-lg-7 col-md-12 col-sm-12 col-12">
             <h5 class="text-uppercase">Add Blog Category</h5>
           </div>
           <div class="col-lg-5 col-md-12 col-sm-12 col-12">
             <ul class="list-inline breadcrumb float-right">
               <li class="list-inline-item"><a href="{{ route('home') }}">Home</a></li>
               {{-- <li class="list-inline-item"><a href="{{ route('blog.index') }}">Blog Category</a></li> --}}
             </ul>
           </div>
         </div>
       </div>
                 ...
                 <div class="row">
                   ...
                   <div class="col-lg-06 col-md-12 col-sm-12 col-12">
                       <div class="form-group custom-mt-form-group">
                         <input type="text" placeholder="Enter your Name" name="category_name"/>
                   ...
                   <div class="col-lg-06 col-md-12 col-sm-12 col-12">
                     <div class="table-responsive-lg">
                         <table class="table table-striped custom-table datatable">
                             ...
                             <tbody>
                               @foreach ($blogcategory as $blogcateg)
                                 <tr>
                                     <td>
                                         <h2><a href="">{{ $blogcateg->category_name }}<span></span></a></h2>
                                           </td>
                                          <td class="text-right" >
                                             <a href="{{ route('blogcategory.edit', [$blogcateg->id]) }}" class="btn btn-primary btn-sm mb-1">
